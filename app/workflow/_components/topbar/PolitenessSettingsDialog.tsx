...
export default function PolitenessSettingsDialog() {
  ...
  const poolStr = useMemo(
    () => (cfg?.userAgent.pool ? cfg.userAgent.pool.join('\n') : ''),
    [cfg?.userAgent.pool]
  );
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={cfg.robots.enabled}
                onCheckedChange={(v) =>
                  setCfg((c) => ({ ...c, robots: { ...c.robots, enabled: v } }))
                }
              />
            </div>
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <Select
                  value={cfg.robots.enforcement}
                  onValueChange={(v) =>
                    setCfg((c) => ({ ...c, robots: { ...c.robots, enforcement: v as any } }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div>
                ...
                <Input
                  value={cfg.robots.userAgentOverride ?? ''}
                  onChange={(e) =>
                    setCfg((c) => ({
                      ...c,
                      robots: { ...c.robots, userAgentOverride: e.target.value || undefined },
                    }))
                  }
                />
              </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={cfg.delays.enabled}
                onCheckedChange={(v) =>
                  setCfg((c) => ({ ...c, delays: { ...c.delays, enabled: v } }))
                }
              />
            </div>
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <Input
                  type="number"
                  value={cfg.delays.minMs}
                  onChange={(e) =>
                    setCfg((c) => ({
                      ...c,
                      delays: { ...c.delays, minMs: Number(e.target.value) },
                    }))
                  }
                />
              </div>
              <div>
                ...
                <Input
                  type="number"
                  value={cfg.delays.maxMs}
                  onChange={(e) =>
                    setCfg((c) => ({
                      ...c,
                      delays: { ...c.delays, maxMs: Number(e.target.value) },
                    }))
                  }
                />
              </div>
              <div>
                ...
                <Input
                  type="number"
                  step="0.01"
                  value={cfg.delays.jitterPct}
                  onChange={(e) =>
                    setCfg((c) => ({
                      ...c,
                      delays: { ...c.delays, jitterPct: Number(e.target.value) },
                    }))
                  }
                />
              </div>
              <div>
                ...
                <Select
                  value={cfg.delays.strategy}
                  onValueChange={(v) =>
                    setCfg((c) => ({ ...c, delays: { ...c.delays, strategy: v as any } }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={cfg.userAgent.enabled}
                onCheckedChange={(v) =>
                  setCfg((c) => ({ ...c, userAgent: { ...c.userAgent, enabled: v } }))
                }
              />
            </div>
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <Select
                  value={cfg.userAgent.rotateStrategy}
                  onValueChange={(v) =>
                    setCfg((c) => ({
                      ...c,
                      userAgent: { ...c.userAgent, rotateStrategy: v as any },
                    }))
                  }
                >
                  <SelectTrigger>
              ...
              <div className="flex items-center gap-2">
                ...
                <Switch
                  checked={cfg.userAgent.acceptLanguageRandomization ?? true}
                  onCheckedChange={(v) =>
                    setCfg((c) => ({
                      ...c,
                      userAgent: { ...c.userAgent, acceptLanguageRandomization: v },
                    }))
                  }
                />
              </div>
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setCfg((c) => ({
                    ...c,
                    userAgent: { ...c.userAgent, pool: e.target.value.split('\n').filter(Boolean) },
                  }))
                }
              />
            </div>
            <div>
              ...
              <Textarea
                rows={4}
                value={JSON.stringify(cfg.userAgent.headers || {}, null, 2)}
                onChange={(e) => {
