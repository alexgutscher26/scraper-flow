...
export const UploadFilesTask = {
  ...
  inputs: [
    ...
    { name: 'Selector', type: TaskParamType.STRING, required: true },
    {
      ...
      required: true,
      helperText: 'One per line or comma-separated (absolute or relative paths)',
    },
    {
      name: 'AcceptTypes',
      type: TaskParamType.STRING,
      required: false,
      helperText: 'Regex matched against full file path (e.g. \\.(png|jpg|pdf)$)',
    },
    {
      name: 'MaxSizeMB',
      type: TaskParamType.NUMBER,
      required: false,
      helperText: 'Maximum per-file size in MB',
    },
    ...
    { name: 'DropTargetSelector', type: TaskParamType.STRING, required: false },
    {
      ...
      required: false,
      helperText: 'Fail fast on any invalid file; when off, skip invalid files',
    },
  ] as const,
  outputs: [
